...
//				Utils.log( fe.key == null ? "key is null" : key.equals( fe.key ) ? "key is equal" : "key is not equal" );
	 ...
	 * pixels of an AWT image as generated by {@link Loader#getFlatAWTImage(de.unihalle.informatik.rhizoTrak.display.Layer, java.awt.Rectangle, double, int, int, Class, java.util.List, boolean, java.awt.Color, de.unihalle.informatik.rhizoTrak.display.Displayable) Loader.getFlatAWTImage(...)}
