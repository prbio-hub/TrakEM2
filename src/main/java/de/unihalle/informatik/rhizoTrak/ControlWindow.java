...
package de.unihalle.informatik.rhizoTrak;
...
import de.unihalle.informatik.rhizoTrak.utils.RedPhone;
import de.unihalle.informatik.rhizoTrak.utils.StdOutWindow;
...
public class ControlWindow {
	...
	static private MouseListener tool_listener = new MouseAdapter() {
		...
		public void mousePressed(MouseEvent me) {
			int tool = de.unihalle.informatik.rhizoTrak.utils.ProjectToolbar.getToolId();
			if (tool != last_tool) {
				last_tool = tool;
				de.unihalle.informatik.rhizoTrak.display.Display.toolChanged(tool);
			}
		}
	};
	...
	*/
	...
	static private void setCursor(final Cursor c) {
		Utils.invokeLater(new Runnable() { public void run() {
			...
			de.unihalle.informatik.rhizoTrak.display.Display.setCursorToAll(c);
